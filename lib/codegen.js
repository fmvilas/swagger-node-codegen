    ...
    walker.on('file', async (root, stats, next) => {
      try {
        if (stats.name.substr(0,3) === '___') {
          // CJD:  Cutting in here to handle multiple types of files.
          // I also want to be able to generate models in addition to controller stubs.
          if (stats.name.indexOf('.model.')) {
            //  This is a template for models
            // this file should be handled for each in swagger.<<>>
            /*
          ...
          if (stats.name.indexOf('.interface.')) {
            //  This is a template for controller interfaces
          ...
          if (stats.name.indexOf('.controller.')) {
            // This is a template for controllers
            // this file should be handled for each in swagger.paths
            await generateOperationFiles({
              root,
              templates_dir,
